        ...
        <div className="col d-flex align-items-start">
          ...
          <div>
            ...
            <p className="text-white">
              ...
              We offer a wide range of classes and training programs to help you
              reach your goals.
            </p>
          </div>
        </div>
        ...
        <div className="col d-flex align-items-start">
          ...
          <div>
            ...
            <p className="text-white">
              ...
              bulding and see for your self why prime is voted number 1 fitness
              center in the city.
            </p>
          </div>
        </div>
        <div className="col d-flex align-items-start">
          ...
          <div>
            ...
            <p className="text-white">
              ...
              prime fitness we truly belive in the power of commuinty and giving
              back.
            </p>
          </div>
        </div>
